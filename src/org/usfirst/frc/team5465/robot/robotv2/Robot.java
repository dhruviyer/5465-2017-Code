...
public class Robot extends IterativeRobot {
	...
	final static int SHOOTER_VICTOR_PWM = 2;
    ...
    public void robotInit() {
    	...
    	gyro.calibrate();
     	...
     	robotShoot = new RobotShoot(TALON_ENCODER_SHOOTER_PWM, SHOOTER_VICTOR_PWM);
     	robotShoot.start();
    ...
    public void teleopPeriodic() 
    {
    	...
    	**/
    	...
    	{
    		robotShoot.updateSpeed(leftDriveJoystick.getThrottle());
    	}
    	else
    	{
    		robotShoot.updateSpeed(0);
